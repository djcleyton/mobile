    ...
    if (error) {
        return (
            <View style={styles.loading}>
                ...
                <Link href="/">
                    <Text style={styles.loadingText}>Desculpe o transtorno tente novamente</Text>
                </Link>
            </View>
        )
    }
            ...
            <View style={{ paddingLeft: 16, paddingRight: 16, flex: 1 }}>
                {data && Object.keys(data).length > 0 && (
                    <>
                        ...
                        <Text style={styles.objetive}>Foco: {data.objetivo}</Text>
                        ...
                        <ScrollView>
                            ...
                            <View style={styles.supplements}>
                                <View style={styles.food}>
                                    <Text style={styles.foodName}>Dica Suplemento:</Text>
